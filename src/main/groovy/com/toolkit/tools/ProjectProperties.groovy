 ...
 */ 
 ...
 public class ProjectProperties
 {
    ...
    String gitHubUser = "martin";


   /** 
    * Variable full name of original author.
    */  
    String author = "Martin Quickman";

   /** 
    * Variable name of email for documentation purposes.
    */  
    String email = "martin.quickman@yahoo.co.uk";
    ...
    */  
    String packageFolder = "/com/toolkit/tools";


   /** 
    * Variable value of package statement copied into jvm language source code.
    */  
    String packageName = "package com.toolkit.tools;";
    ...
    */  
    String packagePrefix = "com.toolkit.tools.";
    ...
    public int load()
    {
        ...
        file3.withReader { reader ->
            while (line = reader.readLine()) {
                ...
                if (txs.trim().size() > 0 )
                {
                    // packagename =package com.toolbag.tools; 
                    toks = txs.split('=')
